...
public:
    plansza();
    void put_cards(std::vector<card>, std::vector<card>); /// 1. kładiesz jedna karte  2. kładziesz 2 lub wiecej kart (int do rozpoznawania) push_back w pętli
    void take_cards(std::vector<card>, int); /// 1. zabierasz 1 karte  2. zabierasz 2 lub wiecej kart (int do rozpoznawania) pop_back w pętli
    bool isOneHigher(std::vector<card>, std::vector<card>, int); // Do planszy
    void setup();
};
